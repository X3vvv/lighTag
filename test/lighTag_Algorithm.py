...
def main():
    ...
    while True:
        ...
        if (inDisArr != -1):
            ...
            print(quartPosition(XA,YA,ZA,inDisArr[0],XB,YB,ZB,inDisArr[1],XC,YC,ZC,inDisArr[2],XD,YD,ZD,inDisArr[3])) # Calculate the 3D location of the tag
        else:
            print("Error!")
        print("/n")
        ...
        for i in range(0,len(inStr),2):
            ...
            if (i == 12 or i == 14 or i == 16 or i == 18 or i == 20 or i == 22 or i == 24 or i == 26): # High 8 bits (2 bytes)
                ...
                if (i == 14 or i == 18 or i == 22 or i == 26): # Low 8 bits (2 bytes)
                    ...
                    out = val + arr[int(i/2-1)] # Add the high 8 bits distance to the low 8 bits distance to get the real distance
                arr.append(out)
